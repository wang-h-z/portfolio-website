...
const socials = [
  { name: 'GitHub', icon: Github, href: 'https://github.com/wang-h-z' },
  { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/wanghaozhen//' },
  { name: 'Email', icon: Mail, href: 'mailto:haozhenwang297@gmail.com' },
];
